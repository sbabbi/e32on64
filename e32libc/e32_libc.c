...
/**
 * @brief Copy opcodes for the tan() wrapper
 */
static e32_function_ptr s_e32_tan( e32_function_ptr addr, size_t size )
{

    static const char prologue[] =
    {
        0xf2, 0x0f, 0x10, 0x44, 0x24, 0x0c // movsd  0xc(%rsp),%xmm0
    };
    
    static const char epilogue[] =
    {
        0xd9, 0x54, 0x24,  0xf8, // fsts   -0x8(%rsp)
        0xf2, 0x0f, 0x10, 0x44, 0x24, 0xf8 //       movsd  -0x8(%rsp),%xmm0
    };
